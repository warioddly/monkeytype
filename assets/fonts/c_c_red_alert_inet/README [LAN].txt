...
My "C&C: Red Alert [LAN] (TrueType)" font is a minifont or also called as a pixelfont.
...
This "C&C: Red Alert [LAN] (TrueType)" font is that one being used inside the C&C: Red Alert LAN lobby.
...
1.) Extract "C&C Red Alert [LAN].ttf" out of this ZIP file, preferred is onto your Desktop
